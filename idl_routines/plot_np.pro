...
contour,[[0,0],[1,1]],/nodata, xstyle=1, ystyle = 1,$
            ...
            title='t = '+strmid(strtrim(string(0.5*nfrm*100.),2),0,5) + ' (s)',$
            /isotropic
...
img_arr=reform(img(*,nz/2-z1:nz/2+z2))
...
colorbar,minrange=min(img_arr),maxrange=max(img_arr),format='(f5.1)',$
          position=[!y.window(0), !x.window(1)+0.01, !y.window(1), $
                    !x.window(1)+0.02],ncolors=255,/vertical,/right,$
          title='mixing',charsize=1.2,divisions=5,minor = 0,yaxis = 1
;,yticks=0,minor = 0,yaxis = 1
...
colorbar,minrange=0,maxrange=1.0,format='(f3.1)',$
          position=[!y.window(0), !x.window(1)+0.01, !y.window(1), $
                    !x.window(1)+0.02],ncolors=255,/vertical,/right,$
          title='mixing',charsize=1.2,divisions=5,minor = 0,yaxis = 1
;,yticks=0,minor = 0,yaxis = 1
